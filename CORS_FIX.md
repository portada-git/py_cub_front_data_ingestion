...
### 1. **Incorrect CORS Origins Format in Environment Variables**
...
### 3. **Missing OPTIONS Method in CORS**
...
#### 2. Enhanced CORS middleware in `main.py`:
```python
app.add_middleware(
    CORSMiddleware,
...
#### 3. Changed default port to 8001:
```python
uvicorn.run(
    "main:app",
    host="0.0.0.0",
